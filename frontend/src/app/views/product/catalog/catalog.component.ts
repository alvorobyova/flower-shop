            ...
            .subscribe(
              {
                ...
                error: (error) => {
                  this.processCatalog(); // сюда попадаем в случае,если пользователь не авторизован, либо по каким-то причинам не смогли загрузить
                  // избранное. Несмотря на это пользователю все равно нужно показать каталог
                }
              }
            );
        } else {
